...
public class ImagesUtil {
	 ...
	 * {@link Media}. Parsing is performed using both
	 ...
	 * @param media the {@link Media} instance to store the parsing
	 *              results to.
	 * @throws IOException if an IO error occurs or no information can be parsed.
	 *
	 */
	public static void parseImage(File file, Media media) throws IOException {
